...
with open_read_only('c:/Users/a1bg468812/PycharmProjects/lagorep/Data Engineer with Python/Data files/Patch installation procedure_PRODv0.4-CDH6.3.4- Yordan Strahinov.txt')\
        as my_file:
  print(my_file.read())