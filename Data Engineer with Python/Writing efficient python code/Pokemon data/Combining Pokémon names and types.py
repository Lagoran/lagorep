...
#replacing 'nan' value in secondary_types with empty value ''

#for n, i in enumerate(secondary_types):
#    if i==nan:
#        secondary_types[i]='empty'
...
print(type(starting_letters_count))

#if we want to show the visual representation of the Couters
plt.bar(type_count.keys(),type_count.values(),align='center')
plt.show()
plt.bar(gen_count.keys(),gen_count.values())
plt.show()
plt.bar(starting_letters_count.keys(),starting_letters_count.values())
plt.show()
